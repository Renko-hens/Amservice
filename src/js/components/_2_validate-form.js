// // Форма
// var form = document.querySelector("#formCabinetAuth");

// // Поля Ввода
// var flashMessages = document.querySelector(".js-flash-message");
// var email = document.querySelector(".form__input--email");
// var code = document.querySelector(".form__input--code");
// var promocode = document.querySelector(".form__input--promocode");
// var checkboxRegistration = document.querySelector("#checkboxRegistration");
// var blockButtons = document.querySelector(".form__wrapper-button");
// var buttonSendCode = document.querySelector("#buttonSendCode");
// var buttonRegistration = document.querySelector("#buttonRegistration");
// var buttonLogIn = document.querySelector("#buttonLogIn");

// var emailRedirect = document.querySelector(".form__link--helper");
// // Все инпуты и чекбоксы
// var inputList = document.querySelectorAll(".form__input");
// var checkboxList = document.querySelectorAll(".custom-checkbox__input");
...
//   code = document.querySelector(".form__input--code");
//   // Проверяем на пустоту
...
//   promocode = document.querySelector(".form__input--promocode");
//   // Проверяем на пустоту
...
//   checkboxRegistration = document.querySelector("#isUserAgreement");
