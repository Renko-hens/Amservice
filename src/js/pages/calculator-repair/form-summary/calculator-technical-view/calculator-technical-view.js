...
const createLoader = (parentInsert) => {
  ...
  parentInsert.append(loader);

  loader.previousElementSibling.classList.add('contact-us__wrapper--loader');
